...
public final class ActivityDetailBinding implements ViewBinding {
  ...
  private ActivityDetailBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView detailRecyclerview) {
  ...
  public static ActivityDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView detailRecyclerview = rootView.findViewById(id);
      if (detailRecyclerview == null) {
        break missingId;
      }

      return new ActivityDetailBinding((FrameLayout) rootView, detailRecyclerview);
    }
